...
#ifndef IPU_BUTTRESS_REGS_H
#define IPU_BUTTRESS_REGS_H
...
/* valid for PTL */
#define BUTTRESS_REG_TIMESTAMP_LO				0x2030
#define BUTTRESS_REG_TIMESTAMP_HI				0x2034
#define BUTTRESS_REG_TIMESTAMP_VALID				0x2038
...
#define BUTTRESS_REG_LTR_CONTROL				0x21a0
#define BUTTRESS_REG_NDE_CONTROL				0x21a4
#define BUTTRESS_REG_INT_FRM_PUNIT				0x21a8
...
/* From PTL, the minimal freq is updated to 325mhz */
#define BUTTRESS_MIN_FORCE_PS_FREQ	(BUTTRESS_PS_FREQ_RATIO_STEP * 13)
#define BUTTRESS_MAX_FORCE_PS_FREQ	(BUTTRESS_PS_FREQ_RATIO_STEP * 30)

#define BUTTRESS_MIN_FORCE_IS_RATIO	5
#define BUTTRESS_MAX_FORCE_IS_RATIO	27

/* IS: 400mhz, PS: 500mhz */
/* Need update CRO_CLK divisor if using CRO_CLK in blocked state */
...
#define BUTTRESS_NDE_RESVEC			0xe
#define BUTTRESS_NDE_VAL_ACTIVE			480
