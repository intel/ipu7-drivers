DefinitionBlock ("", "SSDT", 2, "", "IMG_PTL", 0x20250920)
{
    ...
    Scope (\_SB.PC00)
    {
        ...
        Device (SER0)
        {
            ...
            {
                CSI2Bus(DeviceInitiated, 1, 1, "\\_SB.PC00.DES0", 0,,,) // type 0 for DPHY, DES1 local port 1 remote port 0
        ...
        Device (SER1)
        {
            ...
            Name(_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
                CSI2Bus(DeviceInitiated, 1, 1, "\\_SB.PC00.DES0", 1,,,) // type 0 for DPHY, DES1 local port 1 remote port 1
                I2cSerialBusV2 (0x40, ControllerInitiated, 0x00061A80,  // actual address
                        AddressingMode7Bit, "\\_SB.PC00.DES0",
                        0x00, ResourceConsumer,, Exclusive)
                GpioIo (
        ...
        Device (SER2)
        {
            ...
            Name(_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
                CSI2Bus(DeviceInitiated, 1, 1, "\\_SB.PC00.DES0", 2,,,) // type 0 for DPHY, DES1 local port 1 remote port 2
                I2cSerialBusV2 (0x40, ControllerInitiated, 0x00061A80,  // actual address
                        AddressingMode7Bit, "\\_SB.PC00.DES0",
                        0x00, ResourceConsumer,, Exclusive)
                GpioIo (
        ...
        Device (SER3)
        {
            ...
            Name(_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
                CSI2Bus(DeviceInitiated, 1, 1, "\\_SB.PC00.DES0", 3,,,) // type 0 for DPHY, DES1 local port 1 remote port 3
                I2cSerialBusV2 (0x40, ControllerInitiated, 0x00061A80,  // actual address
                        AddressingMode7Bit, "\\_SB.PC00.DES0",
                        0x00, ResourceConsumer,, Exclusive)
                GpioIo (
        ...
        Device (CAM0)
        {
            ...
            Name(_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
                CSI2Bus(DeviceInitiated, 1, 0, "\\_SB.PC00.SER0", 0,,,) // type 0 for DPHY, SER0 local port 0 remote port 0
        ...
        Device (CAM1)
        {
            ...
            Name(_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
                CSI2Bus(DeviceInitiated, 1, 0, "\\_SB.PC00.SER1", 0,,,) // type 0 for DPHY, SER1 local port 0 remote port 0
        ...
        Device (CAM2)
        {
            ...
            Name(_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
                CSI2Bus(DeviceInitiated, 1, 0, "\\_SB.PC00.SER2", 0,,,) // type 0 for DPHY, SER2 local port 0 remote port 0
        ...
        Device (CAM3)
        {
            ...
            Name(_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
                CSI2Bus(DeviceInitiated, 1, 0, "\\_SB.PC00.SER3", 0,,,) // type 0 for DPHY, SER3 local port 0 remote port 0
